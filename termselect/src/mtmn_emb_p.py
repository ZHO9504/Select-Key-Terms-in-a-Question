...
class MyModel(nn.Module):
    ...
    def forward(self, p, p_pos, p_ner, p_mask, q, q_pos, q_ner, q_mask, c,c_pos,c_ner, c_mask,\
        ...
        concat_feature = torch.cat([p_hiddens,p_q_weighted_hiddens,p_c_weighted_hiddens],2)
        sub_feature =  (p_hiddens -p_q_weighted_hiddens)*(p_hiddens - p_c_weighted_hiddens)
        mul_feature = p_hiddens*p_q_weighted_hiddens*p_c_weighted_hiddens

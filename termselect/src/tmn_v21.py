...
class MyModel(nn.Module):
    ...
    def NA_TriMatching(self,p_hiddens, q_hiddens, c_hiddens,p_mask, q_mask, c_mask):
        ...
        #------matched_self--------------
        self.matched_p = self.matched_self(x = p_hiddens, x_y = p_q_hiddens, x_z = p_c_hiddens, x_mask = p_mask)
        self.matched_q = self.matched_self(x = q_hiddens, x_y = q_p_hiddens, x_z = q_c_hiddens, x_mask = q_mask)
        self.matched_c = self.matched_self(x = c_hiddens, x_y = c_p_hiddens, x_z = c_q_hiddens,   x_mask = c_mask)

...
class MyModel(nn.Module):
    ...
    def forward(self, p, p_pos, p_ner, p_mask, q, q_pos, q_ner, q_mask, c,c_pos,c_ner, c_mask,\
        ...
        #c_c_cat = torch.cat([c_hiddens, matched_c])
        ...
        #c_mfeature = [concat_feature,sub_feature,mul_feature]
        ...
        #c_infer_emb = self.mtinfer(c_mfeature,c_mask,x_order=self.args.matching_order)
